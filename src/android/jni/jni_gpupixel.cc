...
Java_com_pixpark_gpupixel_GPUPixel_adjustBitmap(JNIEnv *jenv, jclass clazz, jobject src) {
...
//    glClientWaitSync(sync, GL_SYNC_FLUSH_COMMANDS_BIT, 1000000000); // 等待 1 秒
